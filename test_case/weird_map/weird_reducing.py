...
class _reducing(unittest.TestCase):
    ...
    def _set_up(self):
        ...
        #     print("Len sector {}".format(len(me.sector[i1])))
        #     for c1, n1 in me.sector[i1].items():
        #         print("({},{})".format(n1.x,n1.y),end='\t')
        #     print()
        ...
        # for i1 in range(15):
        #     TRANSIT_MAP[i1] = [ lambda_n(t1,m1) for t1, m1 in zip(REDUCE_MAP[i1],TRANSIT_MAP[i1]) ]
        #
        # for t_r in TRANSIT_MAP:
        #     print(''.join(t_r))
        # print()
        #
        # for i1 in range(5):
        #     print(TRANSIT_MAP[i1][4:6])
        #     if TRANSIT_MAP[i1][4:6] == ['.','.']:
        #         print("OK")
        #     else:
        #         print("KO")
